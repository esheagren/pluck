    ...
    <div className="min-h-screen bg-gray-50 dark:bg-dark-bg">
      <div className="max-w-2xl mx-auto px-6 py-16">
        ...
        <div className="text-center mb-12">
          <h1 className="text-3xl font-semibold text-gray-800 dark:text-gray-100 mb-2">Pluckk</h1>
          <p className="text-gray-500 dark:text-gray-400">Turn any content into lasting knowledge</p>
        </div>

        {/* About Section */}
        <div className="bg-white dark:bg-dark-surface rounded-xl border border-gray-200 dark:border-dark-border p-6 mb-6">
          <h2 className="text-lg font-medium text-gray-800 dark:text-gray-100 mb-4">About</h2>
          <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-4">
            Pluckk is a browser extension that helps you create spaced repetition flashcards from
            any content you encounter on the web. Simply highlight text or paste a screenshot, and
            Pluckk will generate smart flashcard suggestions using AI.
          </p>
          <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
            Built on the science of spaced repetition, Pluckk helps you retain what you learn by
            turning passive reading into active recall practice.
          </p>
        </div>

        {/* How It Works */}
        <div className="bg-white dark:bg-dark-surface rounded-xl border border-gray-200 dark:border-dark-border p-6 mb-6">
          <h2 className="text-lg font-medium text-gray-800 dark:text-gray-100 mb-4">How It Works</h2>
        ...
        {/* Features */}
        <div className="bg-white dark:bg-dark-surface rounded-xl border border-gray-200 dark:border-dark-border p-6 mb-6">
          <h2 className="text-lg font-medium text-gray-800 dark:text-gray-100 mb-4">Features</h2>
        ...
        <div className="text-center space-y-4">
          ...
          <a
            href="https://pluckk.app/privacy"
            target="_blank"
            rel="noopener noreferrer"
            className="block text-sm text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:hover:text-gray-300 hover:underline transition-colors"
          >
            Privacy Policy
          </a>
        </div>
