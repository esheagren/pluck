...
export default function FeedbackPage() {
  ...
  if (submitted) {
    return (
      <div className="w-full max-w-2xl mx-auto min-h-full flex items-center">
        <div className="w-full bg-white dark:bg-dark-surface rounded-2xl p-8 shadow-sm border border-gray-200 dark:border-dark-border">
  ...
  return (
    <div className="w-full max-w-2xl mx-auto min-h-full flex items-center">
      <div className="w-full bg-white dark:bg-dark-surface rounded-2xl p-8 shadow-sm border border-gray-200 dark:border-dark-border">
        <h2 className="text-xl font-semibold text-gray-800 dark:text-gray-100 mb-6">Share Feedback</h2>
        <textarea
          value={feedback}
          onChange={(e) => setFeedback(e.target.value)}
          placeholder="Tell us what you think..."
          className="w-full p-3 border border-gray-200 dark:border-dark-border rounded-lg text-gray-800 dark:text-gray-200 bg-white dark:bg-dark-bg resize-none focus:outline-none focus:ring-2 focus:ring-gray-200 dark:focus:ring-gray-700 min-h-[150px] dark:placeholder-gray-500"
          autoFocus
        />
        {error && (
