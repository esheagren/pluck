...
/**
 * Sand animation configuration options
 */
export interface SandAnimationOptions {
...
/**
 * Cleanup function returned by initSandAnimation
 */
export type CleanupFunction = () => void;

/**
 * Initialize sand animation on a canvas element
 */
export function initSandAnimation(
  canvas: HTMLCanvasElement | null,
  options: SandAnimationOptions = {}
  ...
  // Create a particle
  function createParticle(xPosition: number | null = null): Particle {
